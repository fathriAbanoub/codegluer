...
# ──────────────────────────────────────────────────────────────────────
# Test 10: is_any_dir detection
# ──────────────────────────────────────────────────────────────────────
assert cg.is_any_dir([os.path.join(TMP, "src")]) == True
assert cg.is_any_dir([os.path.join(TMP, "standalone.txt")]) == False
assert cg.is_any_dir([os.path.join(TMP, "src"), os.path.join(TMP, "standalone.txt")]) == True
passed += 1
...
# ──────────────────────────────────────────────────────────────────────
# Test 17: --toc only for markdown (codegluer constraint)
# Note: codegluer's --toc is markdown-only. We still pass the flag if user
# checked it, codegluer will handle/no-op. Test that flag is passed for markdown.
# ──────────────────────────────────────────────────────────────────────
